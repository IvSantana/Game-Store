document.addEventListener("DOMContentLoaded", function () {
    ...
    const valoresProdutos = {
        "MSI Meg Trident X": 2298.85,
        "Nitro PC AMZ": 889,
        "Beastcom Q3": 469
    };

    const imagensProdutos = {
        "MSI Meg Trident X": "MSI_Meg_Trident_X.png",
        "Nitro PC AMZ": "Nitro_PC_AMZ.png",
        "Beastcom Q3": "Beastcom_Q3.png"
    };
    ...
    function atualizarImagemProduto() {
        ...
        if (produtoSelecionado === "MSI Meg Trident X") {
            
            imgElement.style.width = "100%";  
            imgElement.style.height = "auto"; 
       
        
        } else if (produtoSelecionado === "Nitro PC AMZ") {
        
            imgElement.style.width = "100%";  
            imgElement.style.height = "auto"; 
            
        } else if (produtoSelecionado === "Beastcom Q3") {
