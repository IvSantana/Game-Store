document.addEventListener("DOMContentLoaded", function () {
    ...
    const valoresProdutos = {
        "PS5": 755.55,
        "PS5 SLIM": 549,
        "PS5 Sin lector de discos": 449
    };

    const imagensProdutos = {
        "PS5": "PS5.png",
        "PS5 SLIM": "PS5_SLIM.png",
        "PS5 Sin lector de discos": "PS5_DIGITAL.png"
    };
    ...
    function atualizarImagemProduto() {
        ...
        if (produtoSelecionado === "PS5") {
            
            imgElement.style.width = "100%";  
            imgElement.style.height = "auto"; 
       
        
        } else if (produtoSelecionado === "PS5 SLIM") {
        
            imgElement.style.width = "100%";  
            imgElement.style.height = "auto"; 
            
        } else if (produtoSelecionado === "PS5 Sin lector de discos") {
