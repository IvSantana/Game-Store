document.addEventListener("DOMContentLoaded", function () {
    ...
    const precosProdutos = {
        "Froza Horizon Estándar": 58.70,
        "Froza Horizon Deluxe": 85.99,
        "Froza Horizon Premium": 100
    };

    const imagensProdutos = {
        "Froza Horizon Estándar": "EStandar.png",
        "Froza Horizon Deluxe": "Deluxe.png",
        "Froza Horizon Premium": "Premium.png"
    };
    ...
    function atualizarImagemProduto() {
        ...
        if (imagemProduto) {
            ...
            switch (produtoSelecionado) {
                case "Froza Horizon Estándar":
                    imgElement.style.width = "100%";
                    imgElement.style.height = "auto";
                    break;
                case "Froza Horizon Deluxe":
                    imgElement.style.width = "100%";
                    imgElement.style.height = "auto";
                    break;
                case "Froza Horizon Premium":
                    imgElement.style.width = "100%";
                    imgElement.style.height = "auto";
                    break;
            }
